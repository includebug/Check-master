...
<form action="${ctx}/addValue.action" method="post" name="myform" id="myform">
    <div class="main">
        ...
        <p class="short-input ue-clear">
            <label>上限：</label>
            <textarea id="upperLimit" name="upperLimit"></textarea>
        </p>
    </div>
</form>
...
<script type="text/javascript">
    ...
    //注册
    function addType(){
        document.myform.attributes["action"].value = "${ctx}/addValue.action";
        $("form").submit();
    }
