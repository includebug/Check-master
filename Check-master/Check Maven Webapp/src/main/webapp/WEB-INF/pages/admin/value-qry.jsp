...
<form action="${ctx}/addValue.action" method="post" name="myform" id="myform">
    <div class="main">
        <p class="short-input ue-clear">
            ...
            <input type="text" name="valueType" id="valueType" maxlength="10" value="${type.valueType }" disabled="disabled"/>
        </p>
        <p class="short-input ue-clear">
            <label>分值：</label>
            <input type="text" id="lowerLimit" name="lowerLimit" value="${type.lowerLimit }" disabled="disabled"/>
        </p>
        <p class="short-input ue-clear">
            <label>备注：</label>
            <textarea id="remark" name="upperLimit" disabled="upperLimit">${type.upperLimit }</textarea>
        </p>
    </div>
</form>
...
<script type="text/javascript">
    ...
    //情况所有
    function returnList(){
        document.myform.attributes["action"].value = "${ctx}/toValuePage.action";
        $("form").submit();
    }
